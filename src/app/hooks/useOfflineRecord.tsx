...
export function useOfflineRecord() {
  ...
  // TODO: This method was used to collect data by date and pushed the activity object I'm keeping to use then if is neccessary.
  ...
  // const buildActivitiesByDateToAgenda = (newActivities: any) => {
  //   const activitiesByDate = newActivities.reduce(
  //     (group: any, newActivity: any) => {
  //       const date = newActivity.date;
  //       const name = newActivity.activity;
  //       const formattedDate = moment(newActivity.date).format('YYYY-MM-DD');

  //       group[formattedDate] = group[formattedDate] ?? [];
  //       group[formattedDate].push({date, name});
  //       return group;
  //     },
  //     {},
  //   );
